...
AccountList = [
    {
        ...
        'config': {
            ...
            'auto_daily_combo_max_price': 100_000_000,  # Maximum price of combo for purchase
            ...
            'parallel_upgrades_max_price_per_hour': 1_000,  # Cards with less than X coins per 1k will be bought
